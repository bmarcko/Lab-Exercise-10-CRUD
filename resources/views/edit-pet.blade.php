        ...
        <div class="col-md-8">
            ...
            <form action="/save-edit-pet" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" value="{{ $pet->getName() }}" required>
                </div>
                <div class="form-group">
                    ...
                    <select name="type_animal" class="form-control">
                        ...
                        <option value="invertebrate" @if ($pet->isInsect()) selected @endif>Invertebrate Pet</option>
                        
                    </select>
                </div>
                <div class="form-group">
                    <label>Owner of Pet</label>
                    <input type="text" class="form-control" name="owner" value="{{ $pet->getOwner() }}" required>
                </div>
                <div class="form-group">
                    <label>Address of Owner</label>
                    <textarea class="form-control" name="address">{{ $pet->getAddress() }}</textarea>
                </div>
